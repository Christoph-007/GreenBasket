...
class LoyaltyScreen extends StatelessWidget {
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      _getTierColor(tier),
                      _getTierColor(tier).withOpacity(0.8)
                    ],
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(AppHelpers.getLoyaltyTierLabel(tier),
                              style: AppTextStyles.bodyMedium),
                          const Text('Next Tier',
                              style: AppTextStyles.bodyMedium),
                        ],
                      ),
                      const SizedBox(height: 8),
                      LinearProgressIndicator(
                        value: points / _getNextTierThreshold(tier),
                      ...
                      const SizedBox(height: 8),
                      Text(
                        '${_getNextTierThreshold(tier) - points} more points to reach Next Tier',
              ...
              ..._tiers.map((t) => Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(AppRadius.md),
                      border: Border.all(
                        color: tier == (t['name'] as String).toLowerCase()
                            ? t['color'] as Color
                            : AppColors.border,
                        width:
                            tier == (t['name'] as String).toLowerCase() ? 2 : 1,
                      ),
                    ),
                    child: Row(
                      children: [
  ...
  int _getNextTierThreshold(String tier) {
    switch (tier.toLowerCase()) {
      case 'bronze':
        return 1000;
      case 'silver':
